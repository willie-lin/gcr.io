...
DOCKERHUB_NAMESPACE=willie-lin
...
git_init(){
    git config --global user.name "willie-lin"
    git config --global user.email yyhmmwan@gmail.com
    git remote rm origin
    git remote add origin git@github.com:willie-lin/gcr.io.git
    git pull
